...
return [
    ...
    'permissions' => [
        ...
        Roles::BAC_SECRETARIAT => array_merge(
            ...
            ['ppmp-consolidation.view', 'ppmp-consolidation.review-bac', 'ppmp-consolidation.export'],
        ...
        Roles::BUDGET_OFFICER => array_merge(
            ...
            ['ppmp-consolidation.view', 'ppmp-consolidation.review-budget', 'ppmp-consolidation.export'],
        ...
        Roles::PLANNING_OFFICER => array_merge(
            ...
            P::forModule('ppmp-consolidation'),
        ...
        Roles::ACCOUNTING_OFFICER => array_merge(
            ...
            ['ppmp-consolidation.view', 'ppmp-consolidation.review-accounting', 'ppmp-consolidation.export'],
            ['purchase-order.view'],
            P::forModule('payment'),
            P::forModule('reports'),
            P::forModule('help')
        ...
        Roles::HOPE => array_merge(
            ...
            ['ppmp-consolidation.view', 'ppmp-consolidation.approve-hope', 'ppmp-consolidation.lock', 'ppmp-consolidation.export'],
