    ...
    <div class="flex min-h-screen flex-col lg:flex-row">
        <div class="relative h-48 w-full shrink-0 overflow-hidden lg:hidden">
            @if ($loginBackgroundUrl)
                <img src="{{ $loginBackgroundUrl }}" alt="" class="absolute inset-0 h-full w-full object-cover" decoding="async" />
        ...
        <x-login-brand-panel>
            ...
            <div>
                <p class="text-sm font-medium uppercase tracking-widest text-white/70">Supplier Portal</p>
                <h1 class="mt-3 text-3xl font-bold leading-tight text-white sm:text-4xl">Do business with<br>government, transparently.</h1>
